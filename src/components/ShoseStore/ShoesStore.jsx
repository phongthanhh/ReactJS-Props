...
export default class ShoesStore extends Component {
    ...
    getProductDetail = (shoes) => {
        this.setState({ phoneDetails: shoes })
    }

    render() {
        return (
            <div className='container'>
                <h2 className='py-5'>Shoes Store</h2>
                <ProductList getProductDetail={this.getProductDetail} productsData={this.productsData} />
                <ModalProduct phoneDetail={this.state.phoneDetails} />
            </div>
        )
    }
}
